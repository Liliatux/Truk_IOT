...
class Map extends Component {
	constructor(){
		...
		this.state = {
			...
			<svg version="1.1"  width="100%" height="100%" viewBox="0 0 1000 1000" >
				...
				<path className="animate" d="M660,770 L630,770 L630,640 L320,640 L320,105 L110,105 L110,70" fill="none"  stroke="red" strokeWidth="3"></path>
			</svg>,
			...
			<svg version="1.1"  width="100%" height="100%" viewBox="0 0 1000 1000" >
				...
				<path d="M530,630 L685,630 L685,780" fill="none"  stroke="red" className="animate" strokeWidth="3"></path>
	...
	render(){
		return(
			...
			<div>
				<button onClick={this.changeLevel.bind(this)}>ChangeLevel</button>
				{this.state.default ? this.state.content: this.state.rdc}
			</div>
		);
	}
}
