	...
	render(){
		...
		<div className="Map">
			<svg width="100%" height="100vh">
				...
				<text x="37%" y="4%" font-family="sans-serif" font-size="20px">WC</text>
				...
				<text x="56.5%" y="4%" font-family="sans-serif" font-size="20px">WC</text>
				...
				<text x="69%" y="80%" font-family="sans-serif" font-size="20px">WC</text>
				...
				<text x="3%" y="4%" font-family="sans-serif" font-size="100%">Simplon.co</text>
				<text x="17%" y="4%" font-family="sans-serif" font-size="100%">Simplon.co</text>
				<text x="2.6%" y="15%" font-family="sans-serif" font-size="80%">ProxyMedia</text>
				<text x="18%" y="85%" font-family="sans-serif" font-size="150%">Sigfox</text>
				<text x="7.5%" y="45%" font-family="sans-serif" font-size="150%">CityMeo</text>

				<text x="66%" y="22%" font-family="sans-serif" font-size="150%">U</text>
				<text x="66%" y="25%" font-family="sans-serif" font-size="150%">b</text>
				<text x="66.2%" y="28%" font-family="sans-serif" font-size="150%">i</text>
				<text x="66%" y="31%" font-family="sans-serif" font-size="150%">g</text>
				<text x="66.2%" y="34%" font-family="sans-serif" font-size="150%">r</text>
				<text x="66%" y="37%" font-family="sans-serif" font-size="150%">e</text>
				<text x="66%" y="40%" font-family="sans-serif" font-size="150%">e</text>
				<text x="66%" y="43%" font-family="sans-serif" font-size="150%">n</text>
